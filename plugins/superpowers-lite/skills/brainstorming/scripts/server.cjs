...
.brand { display: block; min-width: 0; overflow: hidden; margin-bottom: 1.5rem; color: #666; font-size: 0.9rem; line-height: 1; }
...
<body><h1>需要会话密钥</h1>
<p>此页面需要编程代理提供的完整 URL，其中必须包含
<code>?key=&hellip;</code>。请复制完整 URL 并重新打开。</p></body></html>`;
...
function brandMarkup() {
  ...
  return '<div class="brand"><span class="brand-copy">Superpowers Lite v' + version + '</span></div>';
}

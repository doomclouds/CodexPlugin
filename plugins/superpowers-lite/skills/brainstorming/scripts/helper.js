(function() {
  ...
  function setStatus(state) {
    ...
    const map = {
      ...
      reconnecting: ['正在重连……',   'var(--warning)'],
      disconnected: ['连接已断开',   'var(--error)']
    };
  ...
  function showTombstone() {
    ...
    el.innerHTML = '<div style="max-width:480px">' +
      '<h2 style="margin:0 0 .5rem;font-weight:600">视觉伴侣已暂停</h2>' +
      '<p style="margin:0;opacity:.85">头脑风暴伴侣已经停止。' +
      '请让编程代理重新启动它，本页会自动重连。</p></div>';
